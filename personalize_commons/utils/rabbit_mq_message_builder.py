...
class RabbitMqMessageBuilder:
    ...
    @staticmethod
    def build_bulk_job_message(event_type: EventType,
                                     payload: Dict[str, Any],
                                     source: str,
                                     retry_count: int = 0
                                     ) -> str:
    ...
    @staticmethod
    def build_job_payload(tenant,campaing,recom):
        return {
            AppConstants.TENANT_ID: tenant,
            AppConstants.CAMPAIGN_ID: campaing,
            AppConstants.RECOMMENDATION_ID: recom,
        }
